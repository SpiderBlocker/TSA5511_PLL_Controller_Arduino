...
// === SYSTEM CONSTANTS ===
    ...
    // timing parameters
        ...
        const unsigned long setLongPressDelay = 750; // delay before SET long-press actions are triggered
...
// === RUNTIME STATE VARIABLES ===
    ...
    bool buttonSetPressed = false; // SET button press latch for edge/repeat handling
